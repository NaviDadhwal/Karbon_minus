      ...
      >
        ...
        {materials.length > 0 && (
          <div className="p-4 bg-black/40 border-t border-white/10 space-y-2.5">
            {project && (
              <Link
                href={`/project/${project.id}/optimize`}
                onClick={onClose}
            ...
            <div className="grid grid-cols-2 gap-2">
              {project && (
                <Link
                  ...
                  onClick={onClose}
                  className="flex items-center justify-center gap-1.5 px-3 py-2 rounded-xl bg-white/5 border border-white/10 text-xs font-semibold text-white hover:bg-white/10 transition"
                >
                  <FileSpreadsheet className="w-3.5 h-3.5 text-accent" /> Carbon Report
                </Link>
              )}
              ...
              <Link
                ...
                className="flex items-center justify-center gap-1.5 px-3 py-2 rounded-xl bg-white/5 border border-white/10 text-xs font-semibold text-white hover:bg-white/10 transition"
              >
                <QrCode className="w-3.5 h-3.5 text-blue-400" /> NFC Passport
              </Link>
            </div>
          </div>
        )}
